                ...
                <div class="card">
                    ...
                    ${semDados
                        ? `<div style="text-align:center; padding: 40px 0; color: var(--text-muted)">
                               ...
                               <p style="margin-top: 12px">Nenhum lançamento ainda.<br>Adicione dados em <strong>Lançamentos</strong>.</p>
                           </div>`
                ...
                <div class="card">
                    ...
                    ${catLabels.length === 0
                        ? `<div style="text-align:center; padding: 40px 0; color: var(--text-muted)">
                               ...
                               <p style="margin-top: 12px">Nenhuma despesa registrada ainda.</p>
                           </div>`
